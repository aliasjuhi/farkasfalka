...
function useAuthQuery(query, options) {
  ...
  const newOptions = __spreadProps(__spreadValues({}, options), { skip: (options == null ? void 0 : options.skip) || !isAuthenticated });
...
export { NhostApolloProvider, useAuthQuery, useAuthSubscription };
