...
const parse = require('./parse-e2fb970d.js');
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
       ...
       */
      const parsedDatetimes = parse.parseDate(parsedValues.length > 0 ? parsedValues : [parse.getToday()]);
      /**
      ...
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = parse.getMonthDayAndYear(locale, firstParsedDatetime);
          const timeText = parse.getLocalizedTime(locale, firstParsedDatetime, use24Hour);
          if (preferWheel) {
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = parse.getMonthDayAndYear(locale, firstParsedDatetime);
          }
          break;
        case 'time':
          this.timeText = parse.getLocalizedTime(locale, firstParsedDatetime, use24Hour);
          break;
        case 'month-year':
          this.dateText = parse.getMonthAndYear(locale, firstParsedDatetime);
          break;
        case 'month':
          this.dateText = parse.getLocalizedDateTime(locale, firstParsedDatetime, { month: 'long' });
          break;
        case 'year':
          this.dateText = parse.getLocalizedDateTime(locale, firstParsedDatetime, { year: 'numeric' });
          break;
      }
    };
    /**
